...
Then edit the SECRET_KEY in local.env file, replace `bg8d7k^m*tf@(=$45_mq2lnmd*!-hyo#*szb5zm$o)m=ma@9tt` into any [Django Secret Key](http://www.miniwebtool.com/django-secret-key-generator/), for example:
